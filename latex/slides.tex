	...
	\begin{center}
		\twotonebox{\rotatebox{90}{Defn}}{\parbox{.86\textwidth}
			{Models of emotion are commonly divided into
				...
				\begin{itemize}
					\item Use Dimensional Emotion Distribution Learning
...
\begin{slide}[toc=,bm=]{Results}
	\begin{center}
		\includegraphics[width=.4\linewidth,height=.25\linewidth]{figures/cnn_acc.eps}
		\quad\includegraphics[width=.4\linewidth,height=.25\linewidth]{figures/cnn_loss.eps}
	\end{center}
	
	\begin{center}
		\includegraphics[width=.4\linewidth,height=.25\linewidth]{figures/lstm_acc.eps}
		\quad\includegraphics[width=.4\linewidth,height=.25\linewidth]{figures/lstm_loss.eps}
	\end{center}
...
\begin{figure}
	\includegraphics[width=.4\linewidth]{figures/vad_emotion.eps}
