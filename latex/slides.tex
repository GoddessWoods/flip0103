...
\begin{slide}{Result}
	\begin{center}
		\includegraphics[width=.4\linewidth,height=.3\linewidth]{figures/cnn_acc.eps}
		\quad\includegraphics[width=.4\linewidth,height=.3\linewidth]{figures/cnn_loss.eps}
	\end{center}
