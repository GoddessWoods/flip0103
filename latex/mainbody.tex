...
~\cite{DBLP:journals/corr/abs-1804-06137,DBLP:journals/corr/abs-1904-00132}.
In the past decades, 
...
However, in later work Russell (1980) argued that the two dimensions
...
And the \Cref{fig:cnn_reuslt} and 
\Cref{fig:lstm_reuslt} present the 
...
\begin{figure}[htbp]
	...
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[height=4.5cm,width=7cm]{figures/cnn_loss.eps}
	\end{minipage}%
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[height=4.5cm,width=7cm]{figures/cnn_acc.eps}
	\end{minipage}
...
\begin{figure}[htbp]
	...
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[height=4.5cm,width=7cm]{figures/lstm_loss.eps}
	\end{minipage}%
	\begin{minipage}[c]{0.5\textwidth}
		\centering
		\includegraphics[height=4.5cm,width=7cm]{figures/lstm_acc.eps}
	\end{minipage}
	\caption{The result of TextCNN}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[height=5cm,width=8cm]{figures/vad_emotion.eps}
